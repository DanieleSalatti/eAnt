...
namespace eAnt.Client
{
	...
	/// </summary>
	public class searchListView : eAntListView
	{
		/// <summary>
		...
		private void m_Globalize()
		{
			...
			Columns[2].Text=eAntForm.Globalization["LBL_SOURCES"];
			Columns[6].Text=eAntForm.Globalization["LBL_FILETYPE"];
			Columns[3].Text=eAntForm.Globalization["LBL_CODEC"];
			Columns[4].Text=eAntForm.Globalization["LBL_LENGTH"];
			Columns[5].Text=eAntForm.Globalization["LBL_BITRATE"];
			ContextMenuSearch.MenuItems[0].Text=eAntForm.Globalization["LBL_DOWNLOAD"];
			ContextMenuSearch.MenuItems[1].Text=eAntForm.Globalization["LBL_DOWNLOAD"]+" ("+eAntForm.Globalization["LBL_STOPPED"]+")";
			ContextMenuSearch.MenuItems[3].Text=eAntForm.Globalization["LBL_COPYLINK"];
			ContextMenuSearch.MenuItems[4].Text=eAntForm.Globalization["LBL_COPYLINK"]+" (HTML)";
			ContextMenuSearch.MenuItems[6].Text=eAntForm.Globalization["LBL_SEARCHINFO"];
		}
		...
		protected override void OnDrawItem(int item,int column,Graphics g,Rectangle rec)
		{
			...
			if ((this.Focused)&&(this.SelectedItems.Contains(itemFile)))
			{
				...
				{
					case eAnt.Types.Constants.SearchResultState.AlreadyDownloaded:
						...
						break;
					case eAnt.Types.Constants.SearchResultState.AlreadyDownloading:
						...
						break;
					case eAnt.Types.Constants.SearchResultState.New:
			...
			if (column==0)
			{
				Image icon=eAntForm.SystemIconsList.GetIconImageOf(file.Name);
				if (icon!=null)
				{
