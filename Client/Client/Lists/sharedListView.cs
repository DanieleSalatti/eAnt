...
namespace eAnt.Client
{
	...
	/// </summary>
	public class sharedListView : eAntListView
	{
		/// <summary>
		...
		private void m_Globalize()
		{
			...
			Columns[2].Text=eAntForm.Globalization["LBL_PRIORITY"];
			Columns[3].Text=eAntForm.Globalization["LBL_PROGRESS"];
			ContextMenuShared.MenuItems[0].Text=eAntForm.Globalization["LBL_OPENFILE"];
			ContextMenuShared.MenuItems[1].Text=eAntForm.Globalization["LBL_DELETEFILE"];
			ContextMenuShared.MenuItems[3].Text=eAntForm.Globalization["LBL_COPYLINK"];
			ContextMenuShared.MenuItems[4].Text=eAntForm.Globalization["LBL_COPYLINK"] + " (HTML)";
			ContextMenuShared.MenuItems[5].Text=eAntForm.Globalization["LBL_COPYLINK"] + " ("+eAntForm.Globalization["LBL_SOURCES"]+")";
			ContextMenuShared.MenuItems[7].Text=eAntForm.Globalization["LBL_PRIORITY"];
			ContextMenuShared.MenuItems[9].Text=eAntForm.Globalization["LBL_SEARCHINFO"];
			PriorityMenu.MenuItems[0].Text=eAntForm.Globalization["LBL_VERYHIGH"];
			PriorityMenu.MenuItems[1].Text=eAntForm.Globalization["LBL_HIGH"];
			PriorityMenu.MenuItems[2].Text=eAntForm.Globalization["LBL_NORMAL"];
			PriorityMenu.MenuItems[3].Text=eAntForm.Globalization["LBL_LOW"];
			PriorityMenu.MenuItems[4].Text=eAntForm.Globalization["LBL_VERYLOW"];
		}
