...
namespace eAnt.Client
{
	...
	/// </summary>
	public class downloadsListView : eAntListView
	{
		/// <summary>
		...
		public downloadsListView()
		{
			...
			/// </summary>
			InitializeComponent();
			if (!base.DesignMode) m_InitControls(); //this doesnt work sometimes
			//if (Application.ExecutablePath.ToLower().IndexOf("\u0065\u006C\u0065\u0070\u0068\u0061\u006E\u0074")>-1) m_InitControls();//sometimes this doesnt work 
			//m_InitControls();
		}
		...
		{
			Columns[0].Text=eAntForm.Globalization["LBL_FILENAME"];
			Columns[1].Text=eAntForm.Globalization["LBL_SIZE"];
			Columns[2].Text=eAntForm.Globalization["LBL_SPEED"];
			Columns[3].Text=eAntForm.Globalization["LBL_COMPLETED"];
			Columns[4].Text=eAntForm.Globalization["LBL_REMAINING"];
			Columns[5].Text=eAntForm.Globalization["LBL_SOURCES"];
			Columns[6].Text=eAntForm.Globalization["LBL_USEFULLSOURCES"];
			Columns[7].Text=eAntForm.Globalization["LBL_TRANSFERS"];
			Columns[8].Text=eAntForm.Globalization["LBL_STATUS"];
			Columns[9].Text=eAntForm.Globalization["LBL_PROGRESS"];
			Columns[10].Text=eAntForm.Globalization["LBL_PRIORITY"];
			Columns[11].Text=eAntForm.Globalization["LBL_ESTIMATED"];
			Columns[12].Text=eAntForm.Globalization["LBL_CATEGORY"];
			ContextMenuDownloads.MenuItems[0].Text=eAntForm.Globalization["LBL_START"];
			ContextMenuDownloads.MenuItems[1].Text=eAntForm.Globalization["LBL_STOP"];
			ContextMenuDownloads.MenuItems[2].Text=eAntForm.Globalization["LBL_CANCEL"];
			ContextMenuDownloads.MenuItems[4].Text=eAntForm.Globalization["LBL_PREVIEW"];
			ContextMenuDownloads.MenuItems[5].Text=eAntForm.Globalization["LBL_OPENFILE"];
			ContextMenuDownloads.MenuItems[7].Text=eAntForm.Globalization["LBL_COPYLINK"];
			ContextMenuDownloads.MenuItems[8].Text=eAntForm.Globalization["LBL_COPYLINK"]+" (HTML)";
			ContextMenuDownloads.MenuItems[10].Text=eAntForm.Globalization["LBL_PRIORITY"];
			ContextMenuDownloads.MenuItems[11].Text=eAntForm.Globalization["LBL_CATEGORY"];

			ContextMenuDownloads.MenuItems[13].Text=eAntForm.Globalization["LBL_SHOWHIDEDETAILS"];
			ContextMenuDownloads.MenuItems[15].Text=eAntForm.Globalization["LBL_SEARCHINFO"];
			ContextMenuDownloads.MenuItems[17].Text=eAntForm.Globalization["LBL_CLEARCOMPLETED"];
			
			PriorityMenu.MenuItems[0].Text=eAntForm.Globalization["LBL_HIGH"];
			PriorityMenu.MenuItems[1].Text=eAntForm.Globalization["LBL_NORMAL"];
			PriorityMenu.MenuItems[2].Text=eAntForm.Globalization["LBL_LOW"];
			m_States=new string[] {
				eAntForm.Globalization["LBL_READY"],
				eAntForm.Globalization["LBL_PAUSED"],
				eAntForm.Globalization["LBL_STOPPED"],
				"","","","","",
				eAntForm.Globalization["LBL_COMPLETING"],
				eAntForm.Globalization["LBL_COMPLETE"],
			};
			m_Priorities=new string[] {
				eAntForm.Globalization["LBL_LOW"],
				eAntForm.Globalization["LBL_NORMAL"],
				eAntForm.Globalization["LBL_HIGH"],
				eAntForm.Globalization["LBL_AUTO"],
			};
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(downloadsListView));
			// 
			// headerImages
			// 
