...
namespace eAnt.Client
{
	...
	/// </summary>
	public class uploadsListView : eAntListView
	{
		/// <summary>
		...
		private void m_Globalize()
		{
			...
			Columns[3].Text=eAntForm.Globalization["LBL_UPLOADED"];
			Columns[4].Text=eAntForm.Globalization["LBL_DOWNLOADED"];
			Columns[5].Text=eAntForm.Globalization["LBL_STATUS"];
			Columns[6].Text=eAntForm.Globalization["LBL_PROGRESS"];
			Columns[7].Text=eAntForm.Globalization["LBL_SOFTWARE"];
			Columns[8].Text=eAntForm.Globalization["LBL_VERSION"];
			ContextMenuUploads.MenuItems[0].Text=eAntForm.Globalization["LBL_SENDMESSAGE"];
			ContextMenuUploads.MenuItems[1].Text=eAntForm.Globalization["LBL_VIEWFILES"];
			ContextMenuUploads.MenuItems[2].Text=eAntForm.Globalization["LBL_ADDFRIEND"];
			m_States=new string[] {
									  eAntForm.Globalization["LBL_NONE"],
									  eAntForm.Globalization["LBL_PENDING"],
									  eAntForm.Globalization["LBL_ONQUEUE"],
									  "",
									  eAntForm.Globalization["LBL_UPLOADING"],
									  "","","",
