...
namespace eAnt.Client
{
	...
	/// </summary>
	public class sourcesListView : eAntListView// baseListView
	{
		/// <summary>
		...
		{
			Columns[0].Text=eAntForm.Globalization["LBL_NAME"];
			Columns[1].Text=eAntForm.Globalization["LBL_FILENAME"];
			Columns[2].Text=eAntForm.Globalization["LBL_SPEED"];
			Columns[3].Text=eAntForm.Globalization["LBL_STATUS"];
			Columns[4].Text=eAntForm.Globalization["LBL_POSITION"];
			Columns[5].Text=eAntForm.Globalization["LBL_DOWNLOADED"];
			Columns[6].Text=eAntForm.Globalization["LBL_UPLOADED"];
			Columns[7].Text=eAntForm.Globalization["LBL_PROGRESS"];
			Columns[8].Text=eAntForm.Globalization["LBL_SOFTWARE"];
			Columns[9].Text=eAntForm.Globalization["LBL_VERSION"];
			ContextMenuSources.MenuItems[0].Text=eAntForm.Globalization["LBL_SENDMESSAGE"];
			ContextMenuSources.MenuItems[1].Text=eAntForm.Globalization["LBL_VIEWFILES"];
			ContextMenuSources.MenuItems[2].Text=eAntForm.Globalization["LBL_ADDFRIEND"];
			m_States=new string[] {
									  eAntForm.Globalization["LBL_PENDING"],
									  eAntForm.Globalization["LBL_DOWNLOADING"],
									  eAntForm.Globalization["LBL_ONQUEUE"],
									  eAntForm.Globalization["LBL_CONNECTING"],
									  eAntForm.Globalization["LBL_CONNECTING_LOWID"],
									  eAntForm.Globalization["LBL_NONEEDEDPARTS"],
									  eAntForm.Globalization["LBL_LOWIDTOLOWID"],
									  "","",
									  eAntForm.Globalization["LBL_ASKING"],
			};
		}
		...
		protected override void OnDrawItem(int item,int column,Graphics g,Rectangle rec)
		{
			...
			if (!Interface.eAntInspector.DrawBar(source.DownFileChunks, g, rec /*new Rectangle(0,0,rec.Width,rec.Height)*/, true, true))
				g.FillRectangle(new SolidBrush(this.BackColor),rec.Left,rec.Height,rec.Width,1);
			else
