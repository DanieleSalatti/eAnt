...
namespace eAnt.Client
{
	...
	public class serversListView : eAntListView
	{
		/// <summary>
		...
		{
			Columns[0].Text=eAntForm.Globalization["LBL_SERVERNAME"];
			Columns[1].Text=eAntForm.Globalization["LBL_ADDRESS"];
			Columns[2].Text=eAntForm.Globalization["LBL_FAILED"];
			Columns[3].Text=eAntForm.Globalization["LBL_FILES"];
			Columns[4].Text=eAntForm.Globalization["LBL_USERS"];
			Columns[5].Text=eAntForm.Globalization["LBL_PRIORITY"];
			ContextMenu.MenuItems[ContextMenuServers.MenuItems.IndexOf(ConnectMenu)].Text = eAntForm.Globalization["LBL_CONNECT"]; 
			ContextMenu.MenuItems[ContextMenuServers.MenuItems.IndexOf(DeleteMenu)].Text = eAntForm.Globalization["LBL_DELETE"]; 
			ContextMenu.MenuItems[ContextMenuServers.MenuItems.IndexOf(CopyLinkMenu)].Text = eAntForm.Globalization["LBL_COPYLINK"]; 
			ContextMenu.MenuItems[ContextMenuServers.MenuItems.IndexOf(CopyLinkHTMLMenu)].Text = eAntForm.Globalization["LBL_COPYLINK"]+" (HTML)";
			ContextMenu.MenuItems[ContextMenuServers.MenuItems.IndexOf(PriorityMenu)].Text = eAntForm.Globalization["LBL_PRIORITY"]; 
			PriorityMenu.MenuItems[PriorityMenu.MenuItems.IndexOf(HighPriorityMenu)].Text = eAntForm.Globalization["LBL_HIGH"]; 
			PriorityMenu.MenuItems[PriorityMenu.MenuItems.IndexOf(NormalPriorityMenu)].Text = eAntForm.Globalization["LBL_NORMAL"]; 
			PriorityMenu.MenuItems[PriorityMenu.MenuItems.IndexOf(LowPriorityMenu)].Text = eAntForm.Globalization["LBL_LOW"]; 
		}
