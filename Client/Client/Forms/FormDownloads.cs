...
namespace eAnt.Client
{
	...
	public class FormDownloads : System.Windows.Forms.Form
	{
		...
		private eAnt.Interface.eAntButton eAntButton1;
		...
		private eAnt.Interface.eAntInspector FileInspector;
		...
		public void HideDetails()
		{
				...
				eAntButton1.ImageList=imageListMinimize;
		...
		private void InitializeComponent()
		{
			...
			this.downloadList = new eAnt.Client.downloadsListView();
			...
			this.eAntButton1 = new eAnt.Interface.eAntButton(this.components);
			...
			this.FileInspector = new eAnt.Interface.eAntInspector();
			this.imageListIcons = new System.Windows.Forms.ImageList(this.components);
			this.tabPageLists = new Crownwood.Magic.Controls.TabPage();
			this.listViewNames = new eAnt.Client.fileNamesListView(this.components);
			this.buttonSetCommet = new System.Windows.Forms.Button();
			this.textBoxComment = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.listViewComments = new eAnt.Client.commentsListView(this.components);
			this.buttonRename = new System.Windows.Forms.Button();
			this.textBoxName = new System.Windows.Forms.TextBox();
			this.label2 = new System.Windows.Forms.Label();
			this.tabPageSources = new Crownwood.Magic.Controls.TabPage();
			this.sourcesList = new eAnt.Client.sourcesListView(this.components);
			...
			// panel6
			// 
			this.panel6.Controls.Add(this.eAntButton1);
			...
			// eAntButton1
			// 
			this.eAntButton1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.eAntButton1.BackColor = System.Drawing.Color.Transparent;
			this.eAntButton1.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.eAntButton1.ImageIndex = 0;
			this.eAntButton1.ImageList = this.imageListMaximize;
			this.eAntButton1.Location = new System.Drawing.Point(672, -5);
			this.eAntButton1.Name = "eAntButton1";
			this.eAntButton1.Size = new System.Drawing.Size(34, 13);
			this.eAntButton1.TabIndex = 7;
			this.eAntButton1.Click += new System.EventHandler(this.eAntButton1_Click);
			// 
			// imageListMaximize
			// 
			...
			this.FileInspector.Size = new System.Drawing.Size(293, 18);
			this.FileInspector.TabIndex = 0;
			this.FileInspector.BarHeight=16;
			this.FileInspector.BarSpacing=1;
			this.FileInspector.BorderWidth=1;
			// 
			// imageListIcons
			// 
		...
		private void UpdateFileInfo(string strHash)
		{
			...
			labelSessionFileDO.Text=eAntForm.Globalization["LBL_DOWNLOADED"]+":"+eAntListView.SizeToString(fileStats.SessionDownload);
			labelSessionFileUP.Text=eAntForm.Globalization["LBL_UPLOADED"]+":"+eAntListView.SizeToString(fileStats.SessionUpload);
			labelSessionFileRateDO.Text=eAntForm.Globalization["LBL_AVGDOWNLOAD"]+":"+eAntListView.SpeedToString(fileStats.AvgDownSpeed);
			labelSessionFileRateUP.Text=eAntForm.Globalization["LBL_AVGUPLOAD"]+":"+eAntListView.SpeedToString(fileStats.AvgUpSpeed);
		...
		private void eAntButton1_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				eAntButton1.ImageList=imageListMaximize;
			}
			if (downloadList.SelectedItems.Count>0)
			{
				int selpos=0;
		...
		private void FormDownloads_SizeChanged(object sender, System.EventArgs e)
		{
			...
			if ((splitter1.SplitPosition>this.Height-20)||(eAntButton1.ImageList==imageListMinimize))
			{
		...
		{
			if (size>102)
				return ((float)size/1024F).ToString("####0.#")+" "+eAntForm.Globalization["LBL_GBYTE"];
			else
				return size.ToString()+" "+eAntForm.Globalization["LBL_MBYTE"];
		}
		...
		private void m_UpdateCategoryLabels()
		{
			...
			//fixed labels
			comboBoxCategories.Items.Add(eAntForm.Globalization["LBL_ALL"]);
			comboBoxCategories.Items.Add(eAntForm.Globalization["LBL_VIDEO"]);
			comboBoxCategories.Items.Add(eAntForm.Globalization["LBL_FILE"]);
			comboBoxCategories.Items.Add(eAntForm.Globalization["LBL_AUDIO"]);
		...
		private void m_UpdateFilterLabels()
		{
			...
			tabPageStopped.Title = eAntForm.Globalization["LBL_STOPPED"];
			if (comboBoxCategories.SelectedIndex>0)
		...
		{
			toolTip1.SetToolTip(eAntButton1,eAntForm.Globalization["LBL_SHOWHIDEDETAILS"]);
			buttonPasteeLink.Text = eAntForm.Globalization["LBL_PASTELINK"];
			buttonAddeLink.Text = eAntForm.Globalization["LBL_ADDLINK"];
			label1.Text = eAntForm.Globalization["LBL_FILTER"];
			tabPageAll.Title = eAntForm.Globalization["LBL_ALL"];
			tabPageStarted.Title = eAntForm.Globalization["LBL_STARTED"];
			tabPageStopped.Title = eAntForm.Globalization["LBL_STOPPED"];
			tabPageDetails.Title = eAntForm.Globalization["LBL_DETAILS"];
			tabPageLists.Title = eAntForm.Globalization["LBL_COMMENTS"];
			buttonSetCommet.Text = eAntForm.Globalization["LBL_SETCOMMENT"];
			label3.Text = eAntForm.Globalization["LBL_FILCOMMENTS"];
			buttonRename.Text = eAntForm.Globalization["LBL_RENAME"];
			label2.Text = eAntForm.Globalization["LBL_FILENAMES"];
			tabPageSources.Title = eAntForm.Globalization["LBL_SOURCES"];
			buttonAdd.Text = eAntForm.Globalization["LBL_ADD"];
			label6.Text = eAntForm.Globalization["LBL_PATH"]+":";
			label5.Text = eAntForm.Globalization["LBL_FILE"]+":";
			buttonCancel.Text = eAntForm.Globalization["LBL_CANCEL"];
			labelCompletedAt.Text = eAntForm.Globalization["LBL_COMPLETEDTIME"]+":";
			menuItemShowTotalSizes.Text=eAntForm.Globalization["LBL_FILTERSHOWSIZES"];
			menuItemShowCount.Text=eAntForm.Globalization["LBL_FILTERSHOWCOUNT"];
			menuItemAutoSort.Text=eAntForm.Globalization["LBL_AUTOSORT"];
			toolTip1.SetToolTip(this.buttonOpenFolder, eAntForm.Globalization["LBL_OPENFOLDER"]);
			manageCategories.Text=eAntForm.Globalization["LBL_MANAGECATEGORIES"];
			groupBoxMaxSources.Text=eAntForm.Globalization["LBL_MAXSOURCESFILE"];
			radioButtonUseGlobalMaxSources.Text=eAntForm.Globalization["LBL_USEGLOBALMAXSOURCES"];
			radioButtonSpecificMaxSources.Text=eAntForm.Globalization["LBL_SPECIFYVALUE"];
		}
		...
		public void ApplySkin()
		{
			...
			label1.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			label1.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			label4.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			label4.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			label2.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			label2.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			label3.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			label3.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			label5.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			label5.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			label6.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			label6.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			labelCompletedAt.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			labelCompletedAt.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			panel_fileDetails.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			panel1.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			
			panel5.BackColor=eAntForm.Skin.GetColor("defaultBackColor");
			panel6.BackColor=eAntForm.Skin.GetColor("defaultBackColor");

			splitter1.BackColor=eAntForm.Skin.GetColor("SplittersBackColor");

			panel7.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			paneleLink.BackColor=eAntForm.Skin.GetColor("panelsBackColor");

			tabControlFilter.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			tabControlDetails.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			tabControlFilter.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			tabControlDetails.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			tabControlFilter.TextInactiveColor=eAntForm.Skin.GetColor("tabsInactiveForeColor");
			tabControlDetails.TextInactiveColor=eAntForm.Skin.GetColor("tabsInactiveForeColor");

			imageListMinimize.Images.Clear();
			imageListMinimize.ImageSize=eAntForm.Skin.GetBitmap("BtnSeparatorUp").Size;
			imageListMinimize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorUp"));
			imageListMinimize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorUpMousePressed"));
			imageListMinimize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorUpMouseUp"));

			imageListMaximize.Images.Clear();
			imageListMaximize.ImageSize=eAntForm.Skin.GetBitmap("BtnSeparatorDown").Size;
			imageListMaximize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorDown"));
			imageListMaximize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorDownMousePressed"));
			imageListMaximize.Images.Add(eAntForm.Skin.GetBitmap("BtnSeparatorDownMouseUp"));

			buttonAdd.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAdd.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonAddeLink.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAddeLink.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonCancel.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonCancel.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonPasteeLink.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonPasteeLink.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonRename.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonRename.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonSetCommet.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonSetCommet.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			textBoxComment.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxComment.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			comboBoxCategories.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			comboBoxCategories.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxName.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxName.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxeLink.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxeLink.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			tx_fileName.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");
			tx_fileName.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");

			tx_completeName.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");
			tx_completeName.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");

			textBoxCompletedAt.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");
			textBoxCompletedAt.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");

			listViewComments.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			listViewComments.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			listViewComments.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			listViewComments.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			listViewComments.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");

            listViewNames.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			listViewNames.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			listViewNames.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			listViewNames.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			listViewNames.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");;

			sourcesList.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			sourcesList.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			sourcesList.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			sourcesList.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			sourcesList.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");;

			downloadList.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			downloadList.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			downloadList.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			downloadList.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			downloadList.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");
			
			labelSessionFileDO.ForeColor=eAntForm.Skin.GetColor("StatusBarDownSpeedTextColor");
			labelSessionFileUP.ForeColor=eAntForm.Skin.GetColor("StatusBarUpSpeedTextColor");
			labelSessionFileRateDO.ForeColor=eAntForm.Skin.GetColor("StatusBarDownSpeedTextColor");
			labelSessionFileRateUP.ForeColor=eAntForm.Skin.GetColor("StatusBarUpSpeedTextColor");

			textBoxMaxSources.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxMaxSources.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			radioButtonSpecificMaxSources.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			radioButtonUseGlobalMaxSources.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			groupBoxMaxSources.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
		...
		{
			menuItemShowCount.Checked=eAntForm.preferences.GetBool("FilterShowCount");
			menuItemShowTotalSizes.Checked=eAntForm.preferences.GetBool("FilterShowTotalSizes");
			menuItemAutoSort.Checked=eAntForm.preferences.GetBool("AutoSort");
		}

		private void menuItemShowCount_Click(object sender, EventArgs e)
		{
			eAntForm.preferences.SetProperty("FilterShowCount",!eAntForm.preferences.GetBool("FilterShowCount"));
			m_UpdateFilterLabels();
		}

		private void menuItemShowTotalSizes_Click(object sender, EventArgs e)
		{
			eAntForm.preferences.SetProperty("FilterShowTotalSizes",!eAntForm.preferences.GetBool("FilterShowTotalSizes"));
			m_UpdateFilterLabels();
		}

		private void menuItemAutoSort_Click(object sender, EventArgs e)
		{
			eAntForm.preferences.SetProperty("AutoSort",!eAntForm.preferences.GetBool("AutoSort"));
		}
		...
		private void radioButtonSpecificMaxSources_CheckedChanged(object sender, System.EventArgs e)
		{
			...
			{
				textBoxMaxSources.Enabled=true;
				textBoxMaxSources.Text=eAntForm.m_Preferences.maxSources.ToString();
			}
		}
