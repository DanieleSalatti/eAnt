...
namespace eAnt.Client
{
	...
	public class FormServers : System.Windows.Forms.Form
	{
		...
		public eAnt.Client.serversListView serversList;
...
//			}
		...
		private void InitializeComponent()
		{
			...
			this.serversList = new eAnt.Client.serversListView(this.components);
		...
		{
			contextMenu1.MenuItems[0].Text=eAntForm.Globalization["LBL_CLEARLOG"];
			labelPort.Text=eAntForm.Globalization["LBL_PORT"]+":";
			buttonAddServer.Text=eAntForm.Globalization["LBL_ADDSERVER"];
			buttonDownloadServerList.Text=eAntForm.Globalization["LBL_DOWNLOAD_SERVERLIST"];
		}
		...
		public void ApplySkin()
		{
			...
			panel4.BackColor=eAntForm.Skin.GetColor("defaultBackColor");

			serversList.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			serversList.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			serversList.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			serversList.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			serversList.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");

			richTextBoxLog.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			richTextBoxLog.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
			...
			buttonAddServer.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAddServer.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");
			
			buttonDownloadServerList.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonDownloadServerList.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");
