...
namespace eAnt.Client
{
	...
	public class FormUploads : System.Windows.Forms.Form
	{
		...
		public eAnt.Client.sharedListView sharedListView;
		private System.Windows.Forms.Panel panelUpDetails;
		public eAnt.Client.uploadsListView uploadsList;
		...
		{
			labelSharedFiles.Text=eAntForm.Globalization["LBL_SHAREDFILES"];
			buttonReload.Text=eAntForm.Globalization["LBL_RELOADSHAREDFILES"];
			tabPageDetails.Title=eAntForm.Globalization["LBL_DETAILS"];
			//tabPageQueue.Title=eAntForm.Globalization["LBL_QUEUE"];
			label6.Text = eAntForm.Globalization["LBL_PATH"]+":";
			label5.Text = eAntForm.Globalization["LBL_FILE"]+":";
			labelSessionDownloaded.Text=eAntForm.Globalization["LBL_DOWNLOADED"];
			labelSessionRequests.Text=eAntForm.Globalization["LBL_REQUESTS"];
			labelSessionUploaded.Text=eAntForm.Globalization["LBL_UPLOADED"];
			labelComment.Text=eAntForm.Globalization["LBL_COMMENT"];
		...
		private void InitializeComponent()
		{
			...
			this.uploadsList = new eAnt.Client.uploadsListView(this.components);
			...
			this.sharedListView = new eAnt.Client.sharedListView(this.components);
		...
		private void m_RefreshStatistics(InterfaceFile file)
		{
			...
			labelSessionDownloadedRes.Text=eAntListView.SizeToString((uint)fstatistics.SessionDownload);
			labelSessionUploadedRes.Text=eAntListView.SizeToString((uint)fstatistics.SessionUpload);
		...
		public void ApplySkin()
		{
			...
			panel1.BackColor=eAntForm.Skin.GetColor("defaultBackColor");
			panel2.BackColor=eAntForm.Skin.GetColor("defaultBackColor");
			panelLeft.BackColor=eAntForm.Skin.GetColor("defaultBackColor");
			panel3.BackColor=eAntForm.Skin.GetColor("defaultBackColor");

			panelLeftDetails.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			panel4.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			panelUpDetails.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			...
			buttonReload.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonReload.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");
			...
			labelSharedFiles.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelSharedFiles.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			sharedListView.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			sharedListView.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			sharedListView.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			sharedListView.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			sharedListView.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");

			uploadsList.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			uploadsList.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			uploadsList.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");
			uploadsList.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();
			uploadsList.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");
			...
			labelSessionRequests.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			labelSessionRequests.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			labelSessionDownloaded.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			labelSessionDownloaded.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			labelSessionUploaded.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			labelSessionUploaded.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			labelComment.ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
			labelComment.BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");

			labelSessionRequestsRes.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");
			labelSessionRequestsRes.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");

			labelSessionDownloadedRes.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");
			labelSessionDownloadedRes.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");

			labelSessionUploadedRes.ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");
			labelSessionUploadedRes.BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");
