...
namespace eAnt.Client
{
	...
	public class FormAviDetails : System.Windows.Forms.Form
	{
		...
		{
			labelVideoInfo.Text = eAntForm.Globalization["LBL_VIDEOINFO"];
			labelVideoCodec.Text = eAntForm.Globalization["LBL_VIDEOCODEC"]+":";
			labelVideoBitrate.Text = eAntForm.Globalization["LBL_VIDEOBITRATE"]+":";
			labelVideoWidth.Text = eAntForm.Globalization["LBL_VIDEOWIDTH"]+":";
			labelVideoHeight.Text = eAntForm.Globalization["LBL_VIDEOHEIGHT"]+":";
			labelVideoLength.Text = eAntForm.Globalization["LBL_VIDEOLENGTH"]+":";
			labelVideoFPS.Text = eAntForm.Globalization["LBL_VIDEOFPS"]+":";
			labelAudioBitrate.Text = eAntForm.Globalization["LBL_AUDIOBITRATE"]+":";
			labelAudioChannels.Text = eAntForm.Globalization["LBL_AUDIOCHANNELS"]+":";
			labelAudioCodec.Text = eAntForm.Globalization["LBL_AUDIOCODEC"]+":";
			labelAudioInfo.Text = eAntForm.Globalization["LBL_AUDIOINFO"];
			labelAudioSampleRate.Text = eAntForm.Globalization["LBL_AUDIOSAMPLERATE"]+":";
		}
		...
		{
			BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			foreach (Control c in this.Controls)
			{
				if (c.GetType()==typeof(Label))
				{
					((Label)c).ForeColor=eAntForm.Skin.GetColor("SquaredLabelsForeColor");
					((Label)c).BackColor=eAntForm.Skin.GetColor("SquaredLabelsBackColor");
				}
				else if	(c.GetType()==typeof(TextBox))
				{
					((TextBox)c).ForeColor=eAntForm.Skin.GetColor("readOnlyTextBoxForeColor");
					((TextBox)c).BackColor=eAntForm.Skin.GetColor("readOnlyTextBoxBackColor");
				}
			}
		}
