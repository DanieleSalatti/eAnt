...
namespace eAnt.Client
{
	...
	public class FormSearch : System.Windows.Forms.Form
	{
		...
		public void m_OnEndSearch(int searchID)
		{
			...
			buttonExtend.Text=eAntForm.Globalization["LBL_SEARCHEXTEND"];
		}
		...
		{
			if (buttonExtend.Text==eAntForm.Globalization["LBL_CANCEL"]) 
			{
		...
		{
			checkBoxSearchAny.Text = eAntForm.Globalization["LBL_SEARCHANY"];
			buttonExtend.Text = eAntForm.Globalization["LBL_SEARCHEXTEND"];
			buttonSearch.Text = eAntForm.Globalization["LBL_SEARCHFILE"];
			labelAvailability.Text = eAntForm.Globalization["LBL_AVAILABILITY"] + " > ";
			labelSizeLower.Text = eAntForm.Globalization["LBL_SIZELOWER"] + " < ";
			labelSizeUpper.Text = eAntForm.Globalization["LBL_SIZEUPPER"] + " > ";
			labelExclude.Text=eAntForm.Globalization["LBL_EXCLUDE"]+":";
			
			comboBoxSearchType.Items.Clear();
			comboBoxSearchType.Items.AddRange(new object[] {   eAntForm.Globalization["LBL_ANY"],
															   eAntForm.Globalization["LBL_VIDEO"],
															   eAntForm.Globalization["LBL_PROGRAM"],
															   eAntForm.Globalization["LBL_AUDIO"],
															   eAntForm.Globalization["LBL_IMAGE"]});
		...
		public void ApplySkin()
		{
			...
			tabSearchs.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			tabSearchs.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");

			labelAvailability.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelAvailability.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelSizeLower.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelSizeLower.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelSizeUpper.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelSizeUpper.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelExclude.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelExclude.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			checkBoxSearchAny.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			checkBoxSearchAny.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			textBoxAvaibility.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxAvaibility.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxSearch.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxSearch.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxMaxSize.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxMaxSize.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxMinSize.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxMinSize.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxExclude.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxExclude.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			comboBoxSearchType.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			comboBoxSearchType.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			buttonSearch.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonSearch.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonExtend.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonExtend.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");
