...
namespace eAnt.Client
{
	...
	public class FormFriends : System.Windows.Forms.Form
	{
		...
		private eAntListView listViewFriends;
		...
		private void m_Globalize()
		{
			...
			listViewFriends.Columns.Add(eAntForm.Globalization["LBL_FRIENDS"],134,false /*HorizontalAlignment.Left*/);
			//labelFriends.Text = eAntForm.Globalization["LBL_FRIENDS"];
			buttonSend.Text = eAntForm.Globalization["LBL_SEND"];
			ContextMenuFriends.MenuItems[0].Text=eAntForm.Globalization["LBL_SENDMESSAGE"];
			ContextMenuFriends.MenuItems[1].Text=eAntForm.Globalization["LBL_VIEWFILES"];
			ContextMenuFriends.MenuItems[3].Text=eAntForm.Globalization["LBL_RENAMEFRIEND"];
			ContextMenuFriends.MenuItems[4].Text=eAntForm.Globalization["LBL_DELETEFRIEND"];
			ContextMenuFriends.MenuItems[6].Text=eAntForm.Globalization["LBL_FRIENDSLOT"];
			buttonAddFriendCancel.Text = eAntForm.Globalization["LBL_CANCEL"];
			labelIP.Text = eAntForm.Globalization["LBL_IP_OR_ID"];
			labelName.Text = eAntForm.Globalization["LBL_NAME"];
			labelPort.Text = eAntForm.Globalization["LBL_PORT"];
			labelUserHash.Text = eAntForm.Globalization["LBL_USERHASH"];
			buttonAddFriend.Text = eAntForm.Globalization["LBL_ADDFRIEND"];
			labelOptional.Text = "(" + eAntForm.Globalization["LBL_OPTIONAL"] + ")";
		}
		...
		private void OnRenameFriend(object sender, System.EventArgs e)
		{
			...
			buttonAddFriendOk.Text=eAntForm.Globalization["LBL_RENAME"];
		...
		private void m_ProcessMessage()
		{
			...
			if (messagePage==null)
			{
				...
				textBoxMsg.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
				textBoxMsg.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
		...
		private void InitializeComponent()
		{
			...
			this.listViewFriends = new eAnt.Client.eAntListView();
		...
		private void buttonAddFriend_Click(object sender, System.EventArgs e)
		{
			...
			buttonAddFriendOk.Text=eAntForm.Globalization["LBL_ADD"];
			textBoxName.Text=eAntForm.Globalization["LBL_MYNEWFRIEND"];
			textBoxIP.Text="";
			textBoxPort.Text="";
		...
		public void ApplySkin()
		{
			...
			panel2.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			panelAddFriend.BackColor=eAntForm.Skin.GetColor("panelsBackColor");

			tabMessages.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			tabMessages.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");

			//labelFriends.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			//labelFriends.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelIP.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelIP.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelName.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelName.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelOptional.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelOptional.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelPort.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelPort.BackColor=eAntForm.Skin.GetColor("labelsBackColor");

			labelUserHash.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			labelUserHash.BackColor=eAntForm.Skin.GetColor("labelsBackColor");
			...
			textBoxIP.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxIP.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxPort.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxPort.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
			
			textBoxUserHash.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxUserHash.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			textBoxMessage.ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
			textBoxMessage.BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");

			buttonAddFriend.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAddFriend.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonAddFriendCancel.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAddFriendCancel.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonAddFriendOk.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonAddFriendOk.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			buttonSend.BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
			buttonSend.ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");

			listViewFriends.ForeColor=eAntForm.Skin.GetColor("listsForeColor");
			listViewFriends.BackColor=eAntForm.Skin.GetColor("listsBackColor");
			listViewFriends.headerForeColor=eAntForm.Skin.GetColor("listsHeaderForeColor");
			listViewFriends.headerBackColor=eAntForm.Skin.GetColor("listsHeaderBackColor");

			//m_SetFlatScrollBar(eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb());
			listViewFriends.ScrollBarBKColor=eAntForm.Skin.GetColor("listsScrollBarBackColor").ToArgb();

			imageListFriends.Images.Clear();
			imageListFriends.Images.Add(eAntForm.Skin.GetBitmap("Friend"));
			imageListFriends.Images.Add(eAntForm.Skin.GetBitmap("FriendSlot"));
