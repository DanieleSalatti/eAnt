...
namespace eAnt.Client
{
	...
	public class FormConnections : System.Windows.Forms.Form
	{
		...
		public FormConnections()
		{
			...
			if (eAntForm.altConnections.Count>0)
			{
				this.textDown1.Text=((eAntForm.connection)eAntForm.altConnections[0]).down.ToString();				
				this.textUp1.Text=((eAntForm.connection)eAntForm.altConnections[0]).up.ToString();
			}
				
			if (eAntForm.altConnections.Count>1)
			{
				this.textDown2.Text=((eAntForm.connection)eAntForm.altConnections[1]).down.ToString();				
				this.textUp2.Text=((eAntForm.connection)eAntForm.altConnections[1]).up.ToString();
			}

			if (eAntForm.altConnections.Count>2)
			{
				this.textDown3.Text=((eAntForm.connection)eAntForm.altConnections[2]).down.ToString();				
				this.textUp3.Text=((eAntForm.connection)eAntForm.altConnections[2]).up.ToString();
			}

			if (eAntForm.altConnections.Count>3)
			{
				this.textDown4.Text=((eAntForm.connection)eAntForm.altConnections[3]).down.ToString();				
				this.textUp4.Text=((eAntForm.connection)eAntForm.altConnections[3]).up.ToString();
			}
		...
		private void m_Globalize()
		{
			...
			lb_cn1.Text=eAntForm.Globalization["LBL_PROFILE"]+" 1:";
			lb_cn2.Text=eAntForm.Globalization["LBL_PROFILE"]+" 2:";
			lb_cn3.Text=eAntForm.Globalization["LBL_PROFILE"]+" 3:";
			lb_cn4.Text=eAntForm.Globalization["LBL_PROFILE"]+" 4:";
			labelDOWN.Text=eAntForm.Globalization["LBL_DO"];
			labelUP.Text=eAntForm.Globalization["LBL_UP"];
		}
