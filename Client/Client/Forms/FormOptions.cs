...
namespace eAnt.Client
{
	...
	public class FormOptions : System.Windows.Forms.Form
	{
		...
		{
			this.Text = eAntForm.Globalization["LBL_OPTIONS"];
			tabPageKernel.Title = eAntForm.Globalization["LBL_KERNEL"];
			tabPageInterface.Title = eAntForm.Globalization["LBL_INTERFACE"];
			labelNick.Text = eAntForm.Globalization["LBL_NICK"]+":";
			groupBoxConnection.Text = eAntForm.Globalization["LBL_CONNECTION"];
			labelMaxDownSpeed.Text = eAntForm.Globalization["LBL_MAXDOWNSPEED"]+":";
			labelMaxUpSpeed.Text = eAntForm.Globalization["LBL_MAXUPSPEED"]+":";
			labelMaxConnection.Text = eAntForm.Globalization["LBL_MAXCONNECTIONS"]+":";
			labelMaxSourcesPerFile.Text = eAntForm.Globalization["LBL_MAXSOURCESPERFILE"]+":";
			labelTCPPort.Text = eAntForm.Globalization["LBL_TCPPORT"]+":";
			labelUDPPort.Text = eAntForm.Globalization["LBL_UDPPORT"]+":";
			checkBoxEnableICH.Text = eAntForm.Globalization["LBL_ENABLEICH"];
			checkBoxAutoConnect.Text= eAntForm.Globalization["LBL_AUTOCONNECT"];
			labelTempFolder.Text = eAntForm.Globalization["LBL_TEMPFOLDER"]+":";
			labelDownloadFolder.Text = eAntForm.Globalization["LBL_DOWNFOLDER"]+":";
			labelSharedFolder.Text = eAntForm.Globalization["LBL_SHAREDFOLDERS"]+":";
			buttonExpTemp.Text = eAntForm.Globalization["LBL_EXPTEMP"];
			buttonExpDown.Text = eAntForm.Globalization["LBL_EXPDOWN"];
			buttonExIncomingFolder.Text = eAntForm.Globalization["LBL_EXPSHARED"];
			buttonRemoveTmp.Text = eAntForm.Globalization["LBL_REMOVETEMP"];
			buttonRemoveDown.Text = eAntForm.Globalization["LBL_REMOVEDOWN"];
			groupBoxViewShared.Text = eAntForm.Globalization["LBL_VIEWSHARED"];
			radioSharedAll.Text = eAntForm.Globalization["LBL_ALL"];
			radioSharedFriends.Text = eAntForm.Globalization["LBL_FRIENDS"];
			radioSharedNobody.Text = eAntForm.Globalization["LBL_NOBODY"];
			groupBoxDownloadServerList.Text = eAntForm.Globalization["LBL_DOWNSERVERLIST"];
			checkBoxDownloadServerMet.Text = eAntForm.Globalization["LBL_DOWNSERVERMET"];
			buttonTakeLinks.Text = eAntForm.Globalization["LBL_TAKELINKS"];
			buttonAccept.Text = eAntForm.Globalization["LBL_ACCEPT"];
			buttonCancel.Text = eAntForm.Globalization["LBL_CANCEL"];
			//checkBoxConnectionAsk.Text = eAntForm.Globalization["LBL_CONNECTIONASK"];
			checkBoxMinTray.Text= eAntForm.Globalization["LBL_MINIMIZETRAY"];
			checkBoxNotifications.Text = eAntForm.Globalization["LBL_NOTIFICATIONS"];
			labelVideoPLayer.Text = eAntForm.Globalization["LBL_VIDEOPLAYER"]+":";
			buttonExplorePlayer.Text = eAntForm.Globalization["LBL_EXPPLAYER"];
			tabPageRemote.Title = eAntForm.Globalization["LBL_REMOTECONTROL"];
			groupBoxRemoteServer.Text = eAntForm.Globalization["LBL_REMOTECONTROL_SERVER"];
			groupBoxRemoteClient.Text = eAntForm.Globalization["LBL_REMOTECONTROL_CLIENT"];
			checkBoxRemoteControl.Text = eAntForm.Globalization["LBL_ENABLE_REMOTECONTROL"];
			labelRemoteControlPass.Text = eAntForm.Globalization["LBL_REMOTECONTROL_PASSWORD"]+":";
			labelRemoteControlPort.Text = eAntForm.Globalization["LBL_REMOTECONTROL_PORT"]+":";
			labelRemoteHostIP.Text = eAntForm.Globalization["LBL_REMOTEHOST_IP"]+":";
			labelRemoteHostPassword.Text = eAntForm.Globalization["LBL_REMOTEHOST_PASSWORD"]+":";
			labelRemoteHostPort.Text = eAntForm.Globalization["LBL_REMOTEHOST_PORT"]+":";
			radioButtonStartLocal.Text = eAntForm.Globalization["LBL_START_Ant_LOCALLY"];
			radioButtonStartRemote.Text = eAntForm.Globalization["LBL_CONNECTREMOTE"];
			radioButtonStartSelect.Text = eAntForm.Globalization["LBL_SELECT_CONNECTIONTYPE"];
			checkBoxOSig.Text = eAntForm.Globalization["LBL_ENABLEOSIG"];
			checkBoxeLinkFromBrowserStopped.Text = eAntForm.Globalization["LBL_ELINK_FROM_BROWSER_STOPPPED"];
			checkBoxIPFilter.Text=eAntForm.Globalization["LBL_ENABLEIPFILTER"];
			labelLanguage.Text=eAntForm.Globalization["LBL_LANGUAGE"]+":";
			labelskin.Text=eAntForm.Globalization["LBL_SKIN"]+":";
			labelCompressionMethod.Text=eAntForm.Globalization["LBL_COMPRESSION"]+":";
			labelIPAllowed.Text=eAntForm.Globalization["LBL_ALLOWEDIP"]+":";
			checkBoxStartPaused.Text=eAntForm.Globalization["LBL_STARTSTOPPEDFILE"];
		}
		...
		{
			toolTipOptions.SetToolTip(this.buttonTakeLinks, eAntForm.Globalization["LBL_TAKELINKS"]);
			toolTipOptions.SetToolTip(this.checkBoxAutoConnect, eAntForm.Globalization["LBL_AUTOCONNECT"]);
			toolTipOptions.SetToolTip(this.checkBoxDownloadServerMet, eAntForm.Globalization["LBL_DOWNSERVERMET"]);
			toolTipOptions.SetToolTip(this.checkBoxeLinkFromBrowserStopped, eAntForm.Globalization["LBL_ELINK_FROM_BROWSER_STOPPPED"]);
			toolTipOptions.SetToolTip(this.checkBoxEnableICH, eAntForm.Globalization["LBL_ENABLEICH"]);
			toolTipOptions.SetToolTip(this.checkBoxIPFilter, eAntForm.Globalization["LBL_ENABLEIPFILTER"]);
			toolTipOptions.SetToolTip(this.checkBoxMinTray, eAntForm.Globalization["LBL_MINIMIZETRAY"]);
			toolTipOptions.SetToolTip(this.checkBoxNotifications, eAntForm.Globalization["LBL_NOTIFICATIONS"]);
			toolTipOptions.SetToolTip(this.checkBoxOSig, eAntForm.Globalization["LBL_ENABLEOSIG"]);
			toolTipOptions.SetToolTip(this.checkBoxRemoteControl, eAntForm.Globalization["LBL_ENABLE_REMOTECONTROL"]);
			toolTipOptions.SetToolTip(this.groupBoxConnection, eAntForm.Globalization["LBL_CONNECTION"]);
			toolTipOptions.SetToolTip(this.groupBoxRemoteServer, eAntForm.Globalization["LBL_REMOTECONTROL_SERVER"]);
			toolTipOptions.SetToolTip(this.groupBoxRemoteClient, eAntForm.Globalization["LBL_REMOTECONTROL_CLIENT"]);
			toolTipOptions.SetToolTip(this.groupBoxDownloadServerList, eAntForm.Globalization["LBL_DOWNSERVERLIST"]);
			toolTipOptions.SetToolTip(this.groupBoxViewShared, eAntForm.Globalization["LBL_VIEWSHARED"]);
			toolTipOptions.SetToolTip(this.labelDownloadFolder, eAntForm.Globalization["LBL_DOWNFOLDER"]);
			toolTipOptions.SetToolTip(this.labelLanguage, eAntForm.Globalization["LBL_LANGUAGE"]);
			toolTipOptions.SetToolTip(this.labelMaxConnection, eAntForm.Globalization["LBL_MAXCONNECTIONS"]);
			toolTipOptions.SetToolTip(this.labelMaxDownSpeed, eAntForm.Globalization["LBL_MAXDOWNSPEED"]);
			toolTipOptions.SetToolTip(this.labelMaxSourcesPerFile, eAntForm.Globalization["LBL_MAXSOURCESPERFILE"]);
			toolTipOptions.SetToolTip(this.labelMaxUpSpeed, eAntForm.Globalization["LBL_MAXUPSPEED"]);
			toolTipOptions.SetToolTip(this.labelNick, eAntForm.Globalization["LBL_NICK"]);
			toolTipOptions.SetToolTip(this.labelRemoteControlPass, eAntForm.Globalization["LBL_REMOTECONTROL_PASSWORD"]);
			toolTipOptions.SetToolTip(this.labelRemoteControlPort, eAntForm.Globalization["LBL_REMOTECONTROL_PORT"]);
			toolTipOptions.SetToolTip(this.labelRemoteHostIP, eAntForm.Globalization["LBL_REMOTEHOST_IP"]);
			toolTipOptions.SetToolTip(this.labelRemoteHostPassword, eAntForm.Globalization["LBL_REMOTEHOST_PASSWORD"]);
			toolTipOptions.SetToolTip(this.labelRemoteHostPort, eAntForm.Globalization["LBL_REMOTEHOST_PORT"]);
			toolTipOptions.SetToolTip(this.labelSharedFolder, eAntForm.Globalization["LBL_SHAREDFOLDERS"]);
			toolTipOptions.SetToolTip(this.labelskin, eAntForm.Globalization["LBL_SKIN"]);
			toolTipOptions.SetToolTip(this.labelTCPPort, eAntForm.Globalization["LBL_TCPPORT"]);
			toolTipOptions.SetToolTip(this.labelTempFolder, eAntForm.Globalization["LBL_TEMPFOLDER"]);
			toolTipOptions.SetToolTip(this.labelUDPPort, eAntForm.Globalization["LBL_UDPPORT"]);
			toolTipOptions.SetToolTip(this.labelVideoPLayer, eAntForm.Globalization["LBL_VIDEOPLAYER"]);
			toolTipOptions.SetToolTip(this.radioButtonStartLocal, eAntForm.Globalization["LBL_START_Ant_LOCALLY"]);
			toolTipOptions.SetToolTip(this.radioButtonStartRemote, eAntForm.Globalization["LBL_CONNECTREMOTE"]);
			toolTipOptions.SetToolTip(this.radioButtonStartSelect, eAntForm.Globalization["LBL_SELECT_CONNECTIONTYPE"]);
			toolTipOptions.SetToolTip(this.radioSharedAll, eAntForm.Globalization["LBL_ALL"]);
			toolTipOptions.SetToolTip(this.radioSharedFriends, eAntForm.Globalization["LBL_FRIENDS"]);
			toolTipOptions.SetToolTip(this.radioSharedNobody, eAntForm.Globalization["LBL_NOBODY"]);
			
			//The diplay is not well displayed
			//toolTipOptions.SetToolTip(this.tabPageKernel, eAntForm.Globalization["LBL_KERNEL"]);
			//toolTipOptions.SetToolTip(this.tabPageInterface, eAntForm.Globalization["LBL_INTERFACE"]);
			//toolTipOptions.SetToolTip(this.tabPageRemote, eAntForm.Globalization["LBL_REMOTECONTROL"]);
		}
		...
		public void DisplayPreferences(InterfacePreferences preferences)
		{
			...
			radioSharedAll.Checked=(preferences.AllowViewShared==eAnt.Types.Constants.AllowViewShared.All);
			radioSharedFriends.Checked=(preferences.AllowViewShared==eAnt.Types.Constants.AllowViewShared.Friends);
			radioSharedNobody.Checked=(preferences.AllowViewShared==eAnt.Types.Constants.AllowViewShared.Nobody);
		...
		{	
			...
			if (radioSharedAll.Checked) preferences.AllowViewShared=eAnt.Types.Constants.AllowViewShared.All;
			else if (radioSharedFriends.Checked) preferences.AllowViewShared=eAnt.Types.Constants.AllowViewShared.Friends;
			else if (radioSharedNobody.Checked) preferences.AllowViewShared=eAnt.Types.Constants.AllowViewShared.Nobody;
		...
		{
			this.checkBoxMinTray.Checked=eAntForm.preferences.GetBool("MinimizeToTray",true);
			this.checkBoxNotifications.Checked=eAntForm.preferences.GetBool("TaskBarNotifier",true);
			...
			this.textBoxPreview.Text=eAntForm.preferences.GetString("PreviewPlayer",defaultplayer);
			//remote control
			this.radioButtonStartRemote.Checked=eAntForm.preferences.GetBool("StartupRemote",false);
			this.radioButtonStartLocal.Checked=eAntForm.preferences.GetBool("StartupLocal",true);
			this.radioButtonStartSelect.Checked=eAntForm.preferences.GetBool("StartupSelect",false);
			this.textBoxRemoteIP.Text=eAntForm.preferences.GetString("RemoteIP","");
			this.textBoxRemotePort.Text=eAntForm.preferences.GetInt("RemotePort",Convert.ToInt32(textBoxRemoteControlPort.Text)).ToString();
			this.textBoxRemotePassword.Text=eAntForm.preferences.GetString("RemotePassword",textBoxRemoteControlPort.Text);
			comboBoxSkin.Text=eAntForm.preferences.GetString("Skin","default");
			comboBoxSkin_SelectedIndexChanged(this,null);
			this.checkBoxeLinkFromBrowserStopped.Checked=eAntForm.preferences.GetBool("eLinkFromBrowserStopped",false);

		}
		private void m_SaveInterfacePreferences()
		{
			eAntForm.preferences.SetProperty("MinimizeToTray",this.checkBoxMinTray.Checked);
			eAntForm.preferences.SetProperty("TaskBarNotifier",this.checkBoxNotifications.Checked);
			eAntForm.preferences.SetProperty("PreviewPlayer",this.textBoxPreview.Text);
			eAntForm.preferences.SetProperty("Language",m_SelectedLanguage);
			//remote control
			eAntForm.preferences.SetProperty("StartupSelect",this.radioButtonStartSelect.Checked);
			eAntForm.preferences.SetProperty("StartupRemote",this.radioButtonStartRemote.Checked);
			eAntForm.preferences.SetProperty("StartupLocal",this.radioButtonStartLocal.Checked);
			eAntForm.preferences.SetProperty("RemoteIP",this.textBoxRemoteIP.Text);
			eAntForm.preferences.SetProperty("RemotePort",Convert.ToInt32(textBoxRemotePort.Text));
			eAntForm.preferences.SetProperty("RemotePassword",textBoxRemotePassword.Text);
			eAntForm.preferences.SetProperty("Skin",comboBoxSkin.Text);
			eAntForm.preferences.SetProperty("eLinkFromBrowserStopped",this.checkBoxeLinkFromBrowserStopped.Checked);
		}
		...
		private void InitializeComponent()
		{
			...
			this.textBoxIncomingFolder.Size = new System.Drawing.Size(200, 21);
			...
			this.textBoxServerMetUri.Size = new System.Drawing.Size(136, 21);
			...
			this.listBoxDownloadsFolder.Size = new System.Drawing.Size(200, 43);
			...
			this.listBoxTmpFolder.Size = new System.Drawing.Size(201, 43);
			...
			this.textBoxUDPPort.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxTCPPort.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxMaxSourcesPerFile.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxMaxConnections.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxMaxUpSpeed.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxMaxDownSpeed.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxNick.Size = new System.Drawing.Size(159, 21);
			...
			this.textBoxPreview.Size = new System.Drawing.Size(170, 21);
			...
			this.textBoxRemotePassword.Size = new System.Drawing.Size(103, 21);
			...
			this.textBoxRemotePort.Size = new System.Drawing.Size(46, 21);
			...
			this.textBoxRemoteIP.Size = new System.Drawing.Size(103, 21);
			...
			this.radioButtonStartSelect.Text = "Select connection type or remote  host when Ant starts";
			// 
			...
			this.radioButtonStartRemote.Text = "Connect to this remote Ant host:";
			// 
			...
			this.radioButtonStartLocal.Text = "Start Ant locally (not remote control)";
			// 
			...
			this.textBoxAddNewIP.Size = new System.Drawing.Size(112, 21);
			...
			this.textBoxRemoteControlPassword.Size = new System.Drawing.Size(103, 21);
			...
			this.textBoxRemoteControlPort.Size = new System.Drawing.Size(46, 21);
		...
		{
			tabControl1.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			tabControl1.ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
			tabControl1.TextInactiveColor=eAntForm.Skin.GetColor("tabsInactiveForeColor");

			foreach (Control c in parentControl.Controls)
			{
				if (c.GetType()==typeof(Label))
				{
						((Label)c).ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
						((Label)c).BackColor=eAntForm.Skin.GetColor("labelsBackColor");
				}
				else if (c.GetType()==typeof(Button))
				{
					((Button)c).BackColor=eAntForm.Skin.GetColor("ButtonBackColor");
					((Button)c).ForeColor=eAntForm.Skin.GetColor("ButtonForeColor");
				}
				else if	(c.GetType()==typeof(TextBox))
				{
					((TextBox)c).ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
					((TextBox)c).BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
				}
				else if	(c.GetType()==typeof(ListBox))
				{
					((ListBox)c).ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
					((ListBox)c).BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
				}
				else if	(c.GetType()==typeof(ComboBox))
				{
					((ComboBox)c).ForeColor=eAntForm.Skin.GetColor("TextBoxForeColor");
					((ComboBox)c).BackColor=eAntForm.Skin.GetColor("TextBoxBackColor");
				}
				else if	(c.GetType()==typeof(RadioButton))
				{
					((RadioButton)c).ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
					((RadioButton)c).BackColor=eAntForm.Skin.GetColor("labelsBackColor");
				}
				else if	(c.GetType()==typeof(GroupBox))
				{
					((GroupBox)c).ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
					if ((c.Controls!=null)&&(c.Controls.Count>0)) m_DoSkin(c);
				}
				else if (c.GetType()==typeof(CheckBox))
				{
						((CheckBox)c).ForeColor=eAntForm.Skin.GetColor("labelsForeColor");
						((CheckBox)c).BackColor=eAntForm.Skin.GetColor("labelsBackColor");
				}
		...
		{
			BackColor=eAntForm.Skin.GetColor("defaultBackColor");
			this.tabControl1.BackColor=eAntForm.Skin.GetColor("panelsBackColor");
			m_DoSkin(this);
		}
		...
		private void comboBoxSkin_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			{
				pictureBoxPreview.Image=new Bitmap(typeof(eAntForm),"Client.Resources.Classic.preview.JPG");
			}
			else
			{
