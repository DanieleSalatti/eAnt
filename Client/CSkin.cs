...
namespace eAnt.Client
{
	...
	public class CSkin
	{
		...
		public CSkin()
		{
			...
			doc.Load(typeof(eAntForm).Assembly.GetManifestResourceStream(typeof(eAntForm),"Client.Resources.Classic.skin.xml"));
		...
		public Bitmap GetBitmap(string imageID)
		{
			...
			if ((m_DefaultSkin())||(notFound)) 
			{
				...
				try
				{
					return new Bitmap(typeof(eAntForm),"Client.Resources.Classic."+resourceName);
				}
				catch
				{
					try
