...
namespace eAnt.eDonkey
{
	...
	internal class Protocol
	{
		...
		public const uint EMULE_VERSION_MAJOR = eAnt_VERSION_MAJOR;
		public const uint EMULE_VERSION_MIN = eAnt_VERSION;
		public const uint EMULE_VERSION_REVISON = 0;
		public const uint EMULE_VERSION_COMPLEX=(uint)(
			(int)Protocol.Client.eAnt<<24)|
		...
		public const uint eAnt_VERSION=40;
		public const uint eAnt_VERSION_MAJOR=1;
		...
		public const byte ET_eAntVERSION=0x99;
		...
		public const string FT_MAXSOURCES="AntMaxSources";
		public const string FT_COMMENT="AntComment";
		public const string FT_RATING="AntRating";
