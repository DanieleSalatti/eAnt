...
namespace eAnt.eDonkey
{
	...
	public class CKernel
	{
		...
		/// <summary>
		/// DoReportBug sends an exception message to the Ant webpage.
		/// </summary>
		...
		public void DoReportBug(string exception)
		{
			try
			{
				string uriString = "http://www.Ant.com/report/bugs.php";
				...
				values.Add("version", Protocol.eAnt_VERSION.ToString());
		...
		/// <summary>
		/// Return the Ant kernel version as string.
		...
		public static string Version
		{
			get
			{
				...
				//current version is 0.07 not 0.7.0.0 so assemply version does not reflect Ant version
		...
		/// <summary>
		/// Return the directory of the Ant kernel.
		/// </summary>
...
*/
		...
		internal static string GetSoftwarebyID(uint ID)
		{
			switch(ID)
			{
				...
				case (uint)Protocol.Client.eAnt:
					return "Ant";
