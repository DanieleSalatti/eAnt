...
namespace eAnt.eDonkey
{
	...
	{
		private TcpServerChannel m_AntChannel;
		private int puerto;
	...
	[Serializable]
	internal class eAntServerSinkProvider:IServerChannelSinkProvider
	{
		...
		public eAntServerSinkProvider (Hashtable Properties, Hashtable ProviderData)
		{
		...
		public IServerChannelSink CreateSink(IChannelReceiver channel)
		{
			...
			{
				this.m_nextSink = new eAntServerChannelSink(this,channel,nextSink);
				return this.m_nextSink;
			}
			else 
			{
				return new eAntServerChannelSink(this,channel,nextSink);
			}
		}
	...
	[Serializable]
	internal class eAntServerChannelSink: BaseChannelObjectWithProperties, IServerChannelSink
	{
		private IServerChannelSink m_NextIServerChannelSink = null;
		private eAntServerSinkProvider m_Provider = null;
		...
		public eAntServerChannelSink(IServerChannelSinkProvider Provider, IChannelReceiver channel)
		{
			...
			if (Provider != null) m_Provider=Provider as eAntServerSinkProvider;
