...
namespace eAnt.eDonkey
{
	...
	internal class ChttpDownload
	{
		...
		{	
			...
			myHttpWebRequest.UserAgent = "www.Ant.com";
		...
		/// <summary>
		/// Get informations from a web site. You can receive Ant news.
		/// </summary>
		/// <param name="remoteUri">
		...
		<info> 
		<version>Ant-v0.01-pré5</version> 
		<log>
		-----------
		*Ant-v0.01-pre5
		*Ant-v0.01-pre5
		...
		*Ant-v0.01-pre5
		...
		<statusbar>Ant-v0.01-pre5</statusbar> 
		<messagebox>xxx xxx xx xxxxxx</messagebox> 
		</info>
		
		string[] myLog = new string[] {"log","version"};
		httpDownload.GetInfoXML(@"http://localhost/Ant/xml.xml",mylog,true);
